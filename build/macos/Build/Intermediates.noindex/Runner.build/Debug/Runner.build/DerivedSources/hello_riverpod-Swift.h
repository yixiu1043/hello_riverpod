...
#ifndef HELLO_RIVERPOD_SWIFT_H
#define HELLO_RIVERPOD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="hello_riverpod",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14hello_riverpod11AppDelegate")
...
SWIFT_CLASS("_TtC14hello_riverpod17MainFlutterWindow")
